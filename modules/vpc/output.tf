...
output "secondary_public_subnet_ids" {
  value = try(aws_subnet.secondary-public[*].id, [])
}

output "secondary_private_subnet_ids" {
  value = try(aws_subnet.secondary-private[*].id, [])
}

output "secondary_private_subnet_azs" {
  value = try(aws_subnet.secondary-private[*].availability_zone)
}